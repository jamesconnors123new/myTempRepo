...
public class BindingsEIS implements IntegrationBase{

    private static final String BASE_URL = "https://ageasdirect-api.uat.EIScloud.co.uk";
    ...
    public BindingsEIS(Resources resources, String bodyTemplateValue) throws Exception {
