...
public class PolicyCreationMotorOnEchelonUI extends EchelonLoggedInBase<EchelonVer001> implements ActivityEndpoint {
...
//      echelonPolicyCreationPage.referralConfirmation(); Do not delete
      ...
      resultsData.put(POLICY_NUMBER, policyNumber);
      resultsData.put(PAYMENTS_STATUS, paymentStatus);
